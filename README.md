...
> AI generated code:Parts of the code in this repository is generated by the help of AI, all parts are at this point not verified/reviewed by a human. if you use it please be aware for bugs and security issues.
> If you have any issues please create a issue inside this repository
> Also see readme footer for more information

OpenMux is a Serial "Terminal Server" with HTML5 web-interface and cli client for remotely controlling and logging multiple serial ports on a device.
This software is ment for controlling "ascii" like serial ports like network equipment console serial ports on eg. cisco/juniper devices. 

The server acts as the control daemon that connects to the serial ports and the clients connect to the openmux server giving access to the ascii serial port.
...
Parts of this codebase and its documentation were created or refactored with assistance from AI coding tools (e.g., GitHub Copilot/Chat). 
